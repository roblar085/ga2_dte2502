...
layer_num = 1
model_temp = PolicyGradientAgentModel(board_size, board_size, frames,0.01).layers[layer_num].output

output_temp = model_temp((torch.Tensor(s.reshape(1, board_size, board_size, frames))))[0,:,:,:]
